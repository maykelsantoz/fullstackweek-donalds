      ...
      <div className="flex-auto">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-center">
            <Button
              variant="outline"
              className="h-8 w-8 z-50 rounded-xl"
        ...
        <div className="mt-6 space-y-3">
          ...
          <p className="flex items-center text-sm text-muted-foreground">{product.description}</p>
        </div>
        <div className="mt-6 space-y-3">
          ...
          <p className="flex items-center text-sm text-muted-foreground">{product.ingredients}</p>
        </div>
      </div>
